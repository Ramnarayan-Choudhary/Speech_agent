# Hindi Configuration Guide

## Overview
Configurations for fine-tuning Whisper models on Hindi (हिंदी) language data from Common Voice 17.0.
...
python src/speech_to_text_finetune/finetune_whisper.py \
    --config example_configs/hindi/config_lora_cpu.yaml
...
- All configs use language="hindi" for Whisper setup
